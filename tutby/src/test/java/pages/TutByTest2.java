...
public class TutByTest2 {

    private WebDriver driver;
    private OnlineCinemaAllGenres onlineCinemaAllGenres;
    private static Logger logger = Logger.getLogger(TutByTest2.class);
    ...
    public void beforeClass() {
        ...
        logger.info("Start before tests, open browser, scenario 2");
    }

    @BeforeMethod
    public void setPageOnlineCinema() {
